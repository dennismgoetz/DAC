...
#Code
```
Allerdings erreicht der XGBoost bei maximaler AUC einen höheren Wert als die logistische Regression. Dies bedeutet, dass der XGBoost bei optimalen Hyperparametern besser für die Klassifikation geeignet ist. Die Unterschiede in der AUC zwischen den Classifiern sind jedoch sehr gering, so dass die Wahl des Classifiers letztendlich keine große Auswirkung hat und der Fokus eher auf der Optimierung des Oversamplings/ Undersampling liegen sollte.
