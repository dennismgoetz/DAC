...
Im Vergelich zum Plot in dem der SMOTE abgebildet wurde, erkennt man Unterschiede wo der Asn SMOTE andere Ergebnisse liefert. Während der Smote einen größeren Bereich abdeckt, in dem die synthetischen Daten entstehen, “ignoriert” der ASN Smote manche Bereiche (Hier im Bereich … zu erkennen). Zusammenfassend lässt sich jedoch sagen, dass der Smote und Asn Smote sehr ähnlich sind und deswegen der Großteil der synthetischen Daten in den gleichen Bereichen entstehen.
