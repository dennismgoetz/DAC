...
ggplot(train_smote, aes(x = V1, y = V2)) +
  ...
  geom_point(data = test[pred_log_reg_smote == 0 & test$Class == 1, ], alpha = 1, color = "red", size = 3) +
...
ggplot(train_asn_smote, aes(x = V1, y = V2)) +
  ...
  geom_point(data = test[pred_log_reg_asn_smote == 0 & test$Class == 1, ], alpha = 1, color = "red", size = 3) +
